...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(code: $code, symbol: $symbol, rate: $rate, rate_float: $rate_float, description: $description)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, code, symbol, rate, rate_float, description);
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      required final double rate_float,
